...
snapshots.add_task("interp(buoyancy, x=aspect*Lz/2)",  name='buoyancy_yz')
snapshots.add_task("interp(buoyancy, y=aspect*Lz/2)",  name="buoyancy_xz")
snapshots.add_task("interp(buoyancy, x=aspect*Lz)",  name="buoyancy_yz_side")
snapshots.add_task("interp(buoyancy, y=aspect*Lz)",  name="buoyancy_xz_side")
snapshots.add_task("interp(buoyancy, z=0.75*Lz)",  name="buoyancy_xy")
snapshots.add_task("interp(buoyancy, z=0.5*Lz)",  name="buoyancy_xy_mid")
snapshots.add_task("interp(buoyancy, z=0.975*Lz)",  name="buoyancy_xy_near_top")

snapshots.add_task("interp(Oz, x=aspect*Lz/2)",  name='vorticity_yz')
snapshots.add_task("interp(Oz, y=aspect*Lz/2)",  name="vorticity_xz")
snapshots.add_task("interp(Oz, x=aspect*Lz)",  name="vorticity_yz_side")
snapshots.add_task("interp(Oz, y=aspect*Lz)",  name="vorticity_xz_side")
snapshots.add_task("interp(Oz, z=0.75*Lz)",  name="vorticity_xy")
snapshots.add_task("interp(Oz, z=0.5*Lz)",  name="vorticity_xy_mid")
snapshots.add_task("interp(Oz, z=0.975*Lz)",  name="vorticity_xy_near_top")

snapshots.add_task("interp(w, z=0.75*Lz)",  name="vertical_velocity")
snapshots.add_task("interp(0.5*(u*u + v*v + w*w), z=0.75*Lz)",  name="kinetic_energy")
...
profiles.add_task("plane_avg(C)", name="T")
